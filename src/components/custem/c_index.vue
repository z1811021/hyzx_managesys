      ...
      <Row>
        ...
        <Col span="8">
          <h4 class="titleB">客户活跃度</h4>
           ...
           <input v-show="data.clientClassify.clientDormancy" type="number" class="inputext" placeholder="填写" v-model.number="data.clientClassify.clientDormancyMoth"/> 月以上未到店）</Checkbox><br/>
